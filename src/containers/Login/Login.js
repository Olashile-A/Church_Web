...
class Login extends Component { 
  ...
  handleLogin = (event) => { 
    ...
    if (!isEmail(email) || !email === undefined) {
      this.setState({
        err: "email",
  ...
  render () {
    ...
    const {  msg, err, email, password, showPassword, isLoading } = this.state;
    const docs = {
        img: "/static/images/dove.png",
      };
    return (
      <div className={classes.paper}>
        ...
        {/* {value.err === "pass" && <Alert severity="warning">{value.msg}</Alert>} */}
        <TextField
            variant="outlined"
            margin="normal"
            required

...
const DetailsConfirmation = (props) => {
  ...
  const handleProceed = () => {
    ...
    setTransferRoute("transferVerification");
  };
        ...
        <Card className={classes.card}>
          ...
          <CardContent className={classes.cardContent}>
            <Grid container spacing={1}  direction='column' justify="center" align="center">
              ...
              <Divider />
              <Grid item xs={12} className={classes.grid}>
                <Typography gutterBottom className={classes.textOne}>Beneficiary</Typography>
                <Typography gutterBottom className={classes.textTwo}>Clam Prayer Center, HQ Lagos</Typography>
              </Grid>
              <Divider />
              <Grid item xs={12} className={classes.grid}>
